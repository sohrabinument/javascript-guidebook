...
<Steps>
    ...
    কিভাবে Reducer বানাতে হয় তা না জানলে [এখানে ক্লিক করুন](https://reactive-accelarator.vercel.app/javascript-guidebook/React-js/module-3/extracting-state-logic-into-reducer)
