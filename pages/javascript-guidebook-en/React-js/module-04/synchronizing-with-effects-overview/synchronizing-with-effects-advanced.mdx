...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🟢 MOUNT</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
    Component renders for the first time ↓ Effect runs
  </div>
</div>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🔄 UPDATE</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
    Dependencies change ↓ Cleanup runs ↓ Effect runs
  </div>
</div>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🔴 UNMOUNT</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>Component is removed ↓ Cleanup runs</div>
</div>
...
<div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#dc2626' }}>🚫 No Array</div>
```jsx
useEffect(() => {
...
<div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#16a34a' }}>✅ Empty Array</div>
```jsx
useEffect(() => {
...
<div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#0284c7' }}>🎯 With Dependencies</div>
```jsx
useEffect(() => {
...
<div style={{
  ...
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🌊 REACTIVE SOURCES</div>
...
<div style={{
  ...
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🎯 EFFECTS REACT</div>
  <ul style={{ fontSize: '0.9rem', margin: 0 }}>
    <li>• Data fetching</li>
    <li>• Subscriptions</li>
    <li>• DOM updates</li>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>🖱️ EVENTS</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em' }}>⚡ EFFECTS</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
...
graph TD
    ...
    C --> G[onClick, onSubmit, onChange, etc.]
    E --> H[useEffect with dependencies]
    F --> I[Maybe move to utility function, service layer, or library]
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#16a34a' }}>
    ✅ Move Inside Effect
  </div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#0284c7' }}>🔧 Use Refs</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
    For values that don't need to trigger re-runs
  </div>
</div>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#f59e0b' }}>🧮 Use Reducers</div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
...
>
  <div style={{ fontWeight: 'bold', fontSize: '1.2em', color: '#9333ea' }}>
    🎭 Extract Non-Reactive
  </div>
  <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
    Move constants and pure functions outside component
  </div>
</div>
...
<div style={{
  ...
  <div style={{ fontWeight: 'bold' }}>Reusability</div>
  <div style={{ fontSize: '0.9rem' }}>Share logic between components</div>
</div>
...
<div style={{
  ...
  <div style={{ fontSize: '2rem' }}>🧹</div>
  <div style={{ fontWeight: 'bold' }}>Separation</div>
  <div style={{ fontSize: '0.9rem' }}>Separate concerns cleanly</div>
</div>
...
<div style={{
  ...
  <div style={{ fontSize: '2rem' }}>🧪</div>
  <div style={{ fontWeight: 'bold' }}>Testability</div>
  <div style={{ fontSize: '0.9rem' }}>Test logic in isolation</div>
</div>
...
<div style={{
  ...
  <div style={{ fontSize: '2rem' }}>📦</div>
  <div style={{ fontWeight: 'bold' }}>Encapsulation</div>
  <div style={{ fontSize: '0.9rem' }}>Hide implementation details</div>
</div>
...
<div style={{ color: '#16a34a', marginTop: 0, fontWeight: 'bold', fontSize: '1.1em' }}>✅ Best Practices</div>
...
<div style={{ color: '#dc2626', marginTop: 0, fontWeight: 'bold', fontSize: '1.1em' }}>❌ Common Mistakes</div>
